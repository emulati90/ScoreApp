...
public class KenyaActivity extends AppCompatActivity {
    ...
    int images[] = {R.drawable.kpl, R.drawable.afc, R.drawable.gor, R.drawable.nzoia, R.drawable.tusker, R.drawable.kpl};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swHome.setFactory(new ViewSwitcher.ViewFactory() {
            ...
            public View makeView() {
                ImageView homeView = new ImageView(KenyaActivity.this);
        ...
        swAway.setFactory(new ViewSwitcher.ViewFactory() {
            @Override
            public View makeView() {
                ImageView awayView = new ImageView(KenyaActivity.this);
        ...
        resetBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                swHome.setImageResource(R.drawable.kpl);
                position1 = 0;
                swAway.setImageResource(R.drawable.kpl);
                position2 = 0;
                goals1 = 0;
                goals2 = 0;
                corner1 = 0;
