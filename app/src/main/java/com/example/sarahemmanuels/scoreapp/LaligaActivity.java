...
public class LaligaActivity extends AppCompatActivity {
    ...
    int images[] = {R.drawable.laliga, R.drawable.barc, R.drawable.rmadrid, R.drawable.amadrid, R.drawable.sevilla, R.drawable.laliga};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swHome.setFactory(new ViewSwitcher.ViewFactory() {
            ...
            public View makeView() {
                ImageView homeView = new ImageView(LaligaActivity.this);
        ...
        swAway.setFactory(new ViewSwitcher.ViewFactory() {
            @Override
            public View makeView() {
                ImageView awayView = new ImageView(LaligaActivity.this);
        ...
        resetBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                swHome.setImageResource(R.drawable.laliga);
                position1 = 0;
                swAway.setImageResource(R.drawable.laliga);
                position2 = 0;
                goals1 = 0;
                goals2 = 0;
                corner1 = 0;
