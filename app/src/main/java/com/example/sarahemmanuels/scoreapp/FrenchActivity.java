...
public class FrenchActivity extends AppCompatActivity {
    ...
    int images[] = {R.drawable.league1, R.drawable.psg, R.drawable.monaco, R.drawable.nantes, R.drawable.marseille, R.drawable.league1};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swHome.setFactory(new ViewSwitcher.ViewFactory() {
            ...
            public View makeView() {
                ImageView homeView = new ImageView(FrenchActivity.this);
        ...
        swAway.setFactory(new ViewSwitcher.ViewFactory() {
            @Override
            public View makeView() {
                ImageView awayView = new ImageView(FrenchActivity.this);
        ...
        resetBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                swHome.setImageResource(R.drawable.league1);
                position1 = 0;
                swAway.setImageResource(R.drawable.league1);
                position2 = 0;
                goals1 = 0;
                goals2 = 0;
                corner1 = 0;
