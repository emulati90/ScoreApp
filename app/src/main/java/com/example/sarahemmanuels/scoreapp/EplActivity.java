...
public class EplActivity extends AppCompatActivity {
    ...
    int images[] = {R.drawable.epl, R.drawable.arsenal, R.drawable.chelsea, R.drawable.man_city, R.drawable.man_u, R.drawable.liverpool, R.drawable.everton,
            R.drawable.leicester_city, R.drawable.epl};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swHome.setFactory(new ViewSwitcher.ViewFactory() {
            ...
            public View makeView() {
                ImageView homeView = new ImageView(EplActivity.this);
        ...
        swAway.setFactory(new ViewSwitcher.ViewFactory() {
            @Override
            public View makeView() {
                ImageView awayView = new ImageView(EplActivity.this);
        ...
        resetBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                swHome.setImageResource(R.drawable.epl);
                position1 = 0;
                swAway.setImageResource(R.drawable.epl);
                position2 = 0;
                goals1 = 0;
                goals2 = 0;
                corner1 = 0;
