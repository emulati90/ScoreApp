...
public class BundesLeagueActivity extends AppCompatActivity {
    ...
    int images[] = {R.drawable.bundes, R.drawable.buyern, R.drawable.burussia, R.drawable.bundes};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bundes_league);
        ...
        swHome.setFactory(new ViewSwitcher.ViewFactory() {
            ...
            public View makeView() {
                ImageView homeView = new ImageView(BundesLeagueActivity.this);
        ...
        swAway.setFactory(new ViewSwitcher.ViewFactory() {
            @Override
            public View makeView() {
                ImageView awayView = new ImageView(BundesLeagueActivity.this);
        ...
        resetBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                swHome.setImageResource(R.drawable.bundes);
                position1 = 0;
                swAway.setImageResource(R.drawable.bundes);
                position2 = 0;
                goals1 = 0;
                goals2 = 0;
                corner1 = 0;
    ...
    private void displayRed1(int red1) {
        TextView red1TextView = (TextView) findViewById(R.id.red1);
        red1TextView.setText("" + red1);
    }
